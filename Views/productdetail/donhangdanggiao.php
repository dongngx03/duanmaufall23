...
<div class="donhang">
    ...
    <div class="donhang-main">
        <table>
           ...
           <?php if($chapnhan!= "")foreach($chapnhan as $value): ?>
           <tr>
                ...
                <td>
                    <a href="#" class="btn btn-primary">Đã nhận được hàng </a>
                </td>
           </tr>
           <?php endforeach; ?>
        </table>
        <div>
            <h2 id="mess" class="text-center text-danger "><?php echo(isset($mess['chapnhan'])?$mess['chapnhan']:'') ?>  <i class="fa-solid fa-face-grin-beam-sweat fa-bounce"></i></h2>
        </div>
    </div>
</div>