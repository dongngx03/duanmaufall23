...
<div class="donhang">
    ...
    <div class="donhang-main">
        <table>
           ...
           <?php if($dahuy!= "")foreach($dahuy as $value): ?>
           <tr>
        ...
        <div>
            <h2 id="mess" class="text-center text-danger "><?php echo(isset($mess['dahuy'])?$mess['dahuy']:'') ?>  <i class="fa-solid fa-face-grin-beam-sweat fa-bounce"></i></h2>
        </div>
    </div>
</div>