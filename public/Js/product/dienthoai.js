...
const sanpham = document.querySelectorAll('.dienthoai-new-product')
// dienthoai-price
const giatien = document.querySelectorAll('.dienthoai-price1')
// dưới 500 nghìn 
...
function checkLv1() {
    ...
    if(lv1[0].checked === true ) {
        ...
        for (let i = 0; i < giatien.length; i++) {
            const price = parseInt(giatien[i].value);
            if(price <= 3000000) {
...
function checkLv2() {
    ...
    if(lv2[0].checked === true ) {
        ...
        for (let i = 0; i < giatien.length; i++) {
            const price2 = parseInt(giatien[i].value);
            if(price2 >= 3000000 && price2 < 5000000) {
                sanpham[i].style.display='block'
            }else{
                sanpham[i].style.display='none' 
            }
...
function checkLv3() {
    ...
    if(lv3[0].checked === true ) {
        ...
        for (let i = 0; i < giatien.length; i++) {
            const price3 = parseInt(giatien[i].value);
            if(price3 >= 5000000 && price3 < 10000000) {
                sanpham[i].style.display='block'
            }else{
                sanpham[i].style.display='none' 
            }
...
function checkLv4() {
    ...
    if(lv4[0].checked === true ) {
        ...
        for (let i = 0; i < giatien.length; i++) {
            const price4 = parseInt(giatien[i].value);
            if(price4 >= 10000000 && price4 < 15000000) {
                sanpham[i].style.display='block'
            }else{
                sanpham[i].style.display='none' 
            }
...
function checkLv5() {
    ...
    if(lv5[0].checked === true ) {
        ...
        for (let i = 0; i < giatien.length; i++) {
            const price5 = parseInt(giatien[i].value);
            if(price5 >=15000000) {
                sanpham[i].style.display='block'
            }else{
                sanpham[i].style.display='none' 
